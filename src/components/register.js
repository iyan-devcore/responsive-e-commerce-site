                        ...
                        <div className="flex-1 space-y-1.5">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    name="lastName"
                                    placeholder="Doe"
                                    className="w-full pl-4 pr-4 py-2.5 bg-white border border-gray-300 rounded-lg text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
