...
// Reuse icons from Register or keep in a separate file. 
// For now, I'll inline them since they are small, or I can move them to a separate file later if asked.
// I'll copy the icon components here to be self-sufficient as requested "create login page".
